...
sidebarLayout(
    sidebarPanel(
        tabsetPanel(
            ...
            fluidRow(column(6, numericInput("mincounts", "Minimum count per feature", value = 0)),
            ...
            fluidRow(column(6, sliderInput("minsum", "Minimum count sum per feature", min = 0, max = 10000, value = 1)),
            column(6, uiOutput("varianceslider"))),
            fluidRow(column(6, sliderInput(
                inputId = "scale",
                label = "Adjust scale (0 = between samples, 1 = between features)",
                value = 0,
                min = 0,
                max = 1,
                step = 1
