...
#'
#' @aliases omicplotr.anosim omicplotr.clr omicplotr.colvec omicplotr.filter omicplotr.colouredPCA omicplotr.getRemovedSamples omicplotr.getRemovedFeatures omicplotr.metadataFilter omicplotr.permanova omicplotr.report
#'
#' @export
#'
